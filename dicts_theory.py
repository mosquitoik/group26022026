...
admin_salary_usd = admin_data.get("salary_usd", 1000)  # None => False
print(admin_salary_usd)
grn_to_usd_rate = 43.72
admin_salary_grn = round(admin_salary_usd * grn_to_usd_rate, 2)
print(admin_salary_grn)

admin_hobbies = admin_data.get('hobbies', [])
has_admin_hobbies = bool(admin_hobbies)
hos_admin_hobbies = len(admin_hobbies) >= 1
